...
import { SourcePayment } from "types/SourcePayment"
import { fetchListKategoriPengeluaran } from "@/actions/category"
import { fetchListSumberDana } from "@/actions/sourcePayment"
import { fetchListPenjual } from "@/actions/store"
...
function CategoryPicker(props: InputProps & {
    ...
    if (status === "success") {
        result = data.pages.reduce((acc: Array<Partial<Category>>, page) => {
...
function StorePicker(props: InputProps & {
    ...
    if (status === "success") {
        result = data.pages.reduce((acc: Array<Partial<Store>>, page) => {
            return [...acc, ...page.data]
        }, [])
    }
...
function SourcePaymentPicker(props: InputProps & {
    ...
    if (status === "success") {
        result = data.pages.reduce((acc: Array<Partial<SourcePayment>>, page) => {
            return [...acc, ...page.data]
        }, [])
    }
